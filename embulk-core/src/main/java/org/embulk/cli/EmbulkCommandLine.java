...
public class EmbulkCommandLine {
    private EmbulkCommandLine(
        ...
        this.systemConfig = SystemConfigProperties.of(systemConfig);
    ...
    public static final class Builder {
        ...
        public EmbulkCommandLine build() {
            final Properties systemConfigJRubyLoadPath = new Properties(this.systemConfig);
            ...
            systemConfigJRubyLoadPath.setProperty(
                    "jruby_load_path", String.join(java.io.File.pathSeparator, jrubyLoadPaths));
            if (this.bundlePath == null) {
                systemConfigJRubyLoadPath.setProperty("jruby_use_default_embulk_gem_home", "true");
            }
    ...
    public final SystemConfigProperties getSystemConfig() {
