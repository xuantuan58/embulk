...
public class LocalExecutorPlugin implements ExecutorPlugin {
    ...
    @Inject
    public LocalExecutorPlugin(final SystemConfigProperties systemConfig) {
        int cores = Runtime.getRuntime().availableProcessors();
        this.defaultMaxThreads = systemConfig.getPropertyAsInteger("max_threads", cores * 2);
        this.defaultMinThreads = systemConfig.getPropertyAsInteger("min_output_tasks", cores);
    }
