...
public class MavenPluginSource implements PluginSource {
    @Inject
    public MavenPluginSource(final Injector injector, final SystemConfigProperties systemConfig) {
    ...
    private Path getLocalMavenRepository() throws PluginSourceNotMatchException {
        final String m2RepoInSystemConfig = this.systemConfig.getProperty("m2_repo", null);
