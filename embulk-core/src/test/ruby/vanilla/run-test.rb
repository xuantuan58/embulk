...
system_config_properties = Java::java.util.Properties.new()
system_config_properties.setProperty("use_global_ruby_runtime", "true")
bootstrap = Java::org.embulk.EmbulkEmbed::Bootstrap.new;
bootstrap.setSystemConfig(system_config_properties);
